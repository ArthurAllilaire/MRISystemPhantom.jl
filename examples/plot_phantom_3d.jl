...
# opacity slider. It lives in a PlotlyJS package *extension* (no hard plotting
# dependency on the core package); the extension activates as soon as PlotlyJS is in the
# session, which `using KomaMRI` pulls in transitively.
#
